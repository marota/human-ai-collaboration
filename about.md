...
I am deeply passionate about human–AI collaboration — its opportunities, its
challenges and its risks — approached as a genuine **partnership**, one that
takes the human's role seriously rather than settling for a naive
...
Mackay in particular — has been a genuine honour, and it shaped how I think about
evidence and about people.

Much of my effort goes into building **open-source and open-science communities**,
and into connecting three worlds that still talk past each other: the AI
community, the critical-systems and operations community, and the
human–machine interaction community. The hard problems sit exactly in the
overlap, and none of the three can reach them alone.

As AI becomes more capable and covers a broader, more complex perimeter, the
means and the infrastructure we use to experiment with it, evaluate it and
certify it have to be reinvented — on a socio-technical and multidisciplinary
basis, and at a scale far beyond what exists today.

This site collects the part of that work concerned with a single question: how do
humans and AI actually make decisions together, and what would have to be measured
before we can say a deployment is safe?

## A collective effort

None of this is solo work. What follows is a partial list of people I have
published, built or run evaluation campaigns with, grouped the same way as the
