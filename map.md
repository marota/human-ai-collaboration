...
<ul class="tiles">
  <li><strong>280</strong><span>Teams</span><em>Research labs, industrial R&amp;D groups, operator R&amp;D teams</em></li>
  <li><strong>113</strong><span>Projects</span><em>Funded projects and programmes — Horizon Europe, SESAR, national</em></li>
  <li><strong>47</strong><span>Frameworks</span><em>Standards, regulations, guidelines, reference models</em></li>
  <li><strong>27</strong><span>Commons</span><em>Open datasets, benchmarks, models, software, communities</em></li>
  <li><strong>308</strong><span>Links</span><em>Which team sits in which project consortium</em></li>
